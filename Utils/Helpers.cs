...
namespace ConsoleApp1.Utils
{
    public static class HelperMethods
    {
        ...
        public static void AddExpense(List<Expense> expenseList)
        {
            ...
            if (categoryId == 0)
            {
                // jak chcesz moge dokonczuc customowe kategorie
                // mozesz tez sam bo nie wiele zostalo
                // poprawisz tutaj troche if i zmienisz methode w categories ktora zwraca to gowno
                // albo mozesz ja tutaj overridowac (chyba, ja jestem z JS stary)
                // czyli dodajesz ja sobie do tej methody z categories gdzie masz food itp
            }
            ...
            int i = 1;
            // tutaj wlasnie masz dane tego expanse uzwyajac displayText methody
        ...
        public static void GenerateExpenseReport(List<Expense> expenseList)
        {
            ...
            if (expenseList.Any())
            {
                // ale zajebista methoda kurwa dzieki bogu bo nie chccialo mi sie recznie tego robic
